    ...
    return (
        <div className={`${themeClasses.bgClass}`}>
            <div className={`max-w-7xl mx-auto py-8 sm:py-12 md:py-16 px-3 sm:px-4 md:px-6 lg:px-8 relative overflow-hidden`}>
                ...
                <h1
                    className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-3 sm:mb-4 md:mb-5 font-heading font-bold text-center text-transparent bg-clip-text ${themeClasses.gradientTextClass} animate-fade-in-down px-2 leading-tight pb-1`}
                    role="banner"
                >
