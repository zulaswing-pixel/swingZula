...
const SHOP_DOMAIN = "swing-9926.myshopify.com"; // UPDATED: Use your actual store domain from JSON
                ...
                <div className="max-w-md mx-auto">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 px-6 py-3 border-2 border-indigo-300 rounded-lg font-semibold text-indigo-700 hover:bg-indigo-50 transition-colors"
                    >
                      Back
                    </button>
                    <button
                      onClick={sendOTP}
                      disabled={!email}
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-700 text-white rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Continue
                    </button>
                  </div>
