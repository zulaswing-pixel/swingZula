...
const SHOP_DOMAIN =process.env.NEXT_PUBLIC_SHOPIFY_STORE_DOMAIN; // UPDATED: Use your actual store domain from JSON
...
export default function CartDrawer({
  ...
  useEffect(() => {
    const handleCartUpdated = () => {
      console.log("Event: cart-updated received → refreshing cart");
      loadCart();
    };

    const handleOpenDrawer = () => {
      console.log("Event: open-cart-drawer received → opening & refreshing");
      setIsOpen(true);
      loadCart();
    };
  ...
  }, [isOpen, customerShopifyId, initialCart, cartId]);
  ...
  const pricing =
    cart?.cost
      ? {
          ...
          duties: Number(cart.cost.totalDutyAmount?.amount || 0),
