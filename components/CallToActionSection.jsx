      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
          <motion.div variants={containerVariants}>
            ...
            <motion.a
              href={ctaHref}
              className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-indigo-600 to-blue-700 text-white font-bold px-10 py-5 rounded-2xl shadow-2xl overflow-hidden text-lg md:text-xl"
              variants={itemVariants}
              whileHover={{
                scale: 1.05,
                y: -4,
